...
public class Box<T extends Boxable> {
    ...
    public static Double getAverageWeightOfFruits(Box<? extends Fruit> fruitBox) {
        return fruitBox.items.stream().mapToDouble(Boxable::getWeight).average().getAsDouble();
    }
}
